...
import { ArrowLeft, User, Phone, Mail, MapPin, Building2, Calendar, Banknote, Activity, ShieldCheck, FileText, CheckCircle, ShieldAlert } from "lucide-react";
  ...
  return (
    <EmployeeLayout title={`Profil Nasabah: ${customer.name}`} subtitle={`ID: ${customer.customerId}`}>
      <div className="mb-6 flex justify-between items-center">
        <Link href="/employee/customers" className="inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-white/70 backdrop-blur-xl border border-white rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] p-6">
            <div className="flex flex-col items-center text-center mb-6">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg mb-4">
        ...
        <div className="lg:col-span-3">
          {/* Tabs */}
          <div className="bg-white/70 backdrop-blur-xl border border-white rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] mb-6 p-2 flex overflow-x-auto hide-scrollbar">
            {TABS.map((tab) => (
              <button
                key={tab.id}
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-4">
                    ...
                    <p className="text-2xl font-bold text-slate-800 mt-1">{customer.totalLoans}</p>
                  </div>
                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-4">
