...
import { logAuditEvent } from "../../admin-lib/audit";
import { findAdminUserById } from "../../admin-data/mockAdminUsers";
  ...
  const handleVerify = async () => {
    ...
    if (result.success) {
      ...
      if (userId) {
        ...
        if (user) {
          logAuditEvent(user, "MFA_VERIFIED", { resource: "Auth", detail: "MFA verification successful" });
          logAuditEvent(user, "LOGIN", { resource: "Auth", detail: "Successful mock SSO + MFA login" });
        }
      }
